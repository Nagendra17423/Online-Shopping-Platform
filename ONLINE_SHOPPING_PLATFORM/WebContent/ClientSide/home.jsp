		...
		<div class="row">
			<div class="col-md-8">
				<div class="row">
					...
					<div class="col-md-6">
						<a href="ClientServlet?id=product&name=Fruits">
							<div
						...
						<a href="ClientServlet?id=product&name=Vegetables">
							<div
			...
			<div class="col-md-4">
				<a href="ClientServlet?id=product&name=Juices">
					<div
						class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
				...
				<a href="ClientServlet?id=product&name=Dried">
