				...
				<div class="col-lg-12 d-block">
					<div class="row d-flex">
						...
						<div
							...
							<span class="text">USER:<%=session.getAttribute("name") %>
							</span>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="AdminServlet?id=home"
						class="nav-link">Home</a></li>
					
					<li class="nav-item"><a href="AdminServlet?id=about" class="nav-link">About</a></li>
					<li class="nav-item"><a href="#products" class="nav-link">Admin Section</a></li>
